...
from flowrunner.drivers.base import Driver, DriverError
from flowrunner.drivers.native import NativeDriver, _Point, walk
...
class TestTreeWalk:
    ...
    def test_the_walk_is_bounded(self, monkeypatch):
        ...
        import flowrunner.drivers.native as native
